...
## Corpus Check
- 603 files · ~111,983 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2791 nodes · 5847 edges · 190 communities (166 shown, 24 thin omitted)
...
- `promotionFixture()` --calls--> `AcademicYear`  [INFERRED]
  tests/Feature/PromotionManagementTest.php → app/Models/AcademicYear.php
...
Cohesion: 0.05
Nodes (11): ActivityLog, CatalogueImportRow, GoodsReceiptLine, PaceStatusEvent, StudentCourse, CatalogueImportRowFactory, StudentCourseFactory, Illuminate\Database\Eloquent\Factories\HasFactory (+3 more)
...
Cohesion: 0.10
Nodes (4): StockMovement, StockMovementPolicy, Illuminate\Database\Eloquent\Relations\HasOne, StockMovementType
...
Cohesion: 0.13
Nodes (5): ReorderController, Supplier, SupplierPolicy, ReorderService, PurchaseOrderFactory
...
Cohesion: 0.16
Nodes (11): Course, CurriculumRequirement, LearningCenter, Level, Subject, CourseFactory, paceAssignmentFixture(), paceIssuingFixture() (+3 more)

### Community 28 - "TwoFactorChallenge.vue"
Cohesion: 0.06
Nodes (13): BackupDatabase, PruneOperationalData, PruneReportExports, ReconcileCatalogue, RestoreDatabase, SystemCheck, SystemHeartbeat, ValidateSystemData (+5 more)
...
Cohesion: 0.08
Nodes (6): NotifyStalePaceAssignments, PaceAssignment, PaceAssignmentPolicy, PaceAttemptFactory, PaceRetryApprovalFactory, PaceStatusEventFactory
...
Cohesion: 0.24
Nodes (4): AcademicPeriodController, TermController, SaveTermRequest, AcademicPeriodService

### Community 49 - "global.d.ts"
Cohesion: 0.09
Nodes (6): PaceAttemptCorrection, Illuminate\Notifications\Notifiable, Illuminate\Support\Facades\Notification, Laravel\Fortify\Contracts\PasskeyUser, Laravel\Fortify\PasskeyAuthenticatable, Laravel\Fortify\TwoFactorAuthenticatable
...
Cohesion: 0.32
Nodes (3): PromotionController, StorePromotionDecisionRequest, StudentPromotionService
...
Cohesion: 0.05
Nodes (15): CreateAdministrator, CatalogueImportController, StaffController, CatalogueImport, Permission, Role, CatalogueImportService, AccessControlSeeder (+7 more)
...
Cohesion: 0.08
Nodes (18): Props, Grade, StudentValues, Course, Level, Subject, Order, props (+10 more)

### Community 70 - "AppSidebar.vue"
Cohesion: 0.03
Nodes (24): ResetStaffPasswordRequest, SaveAcademicYearRequest, SaveCourseRequest, SaveCurriculumRequirementRequest, SaveLevelRequest, SavePaceRequest, SaveSubjectRequest, StoreCatalogueImportRequest (+16 more)
...
Cohesion: 0.07
Nodes (4): GoodsReceipt, GoodsReceiptFactory, GoodsReceiptLineFactory, Illuminate\Database\Eloquent\Relations\HasMany
...
Cohesion: 0.13
Nodes (5): StudentEnrollmentController, SaveStudentEnrollmentRequest, Student, StudentEnrollment, StudentEnrollmentService

### Community 81 - "Badge.vue"
Cohesion: 0.07
Nodes (24): Props, Props, emit, handleDelete(), isDeleting, props, emit, name (+16 more)

### Community 83 - "DropdownMenuContent.vue"
Cohesion: 0.17
Nodes (10): AcademicYear, Term, EnrollmentStatus, inventoryAssignmentFixture(), assessmentFixture(), activeRegistrationPeriod(), createIssuingReportFixture(), createReportFixture() (+2 more)

### Community 84 - "DropdownMenuRadioItem.vue"
Cohesion: 0.05
Nodes (18): AcademicYearFactory, CatalogueImportFactory, CurriculumRequirementFactory, InventoryItemFactory, LearningCenterFactory, LevelFactory, PaceFactory, ReportExportFactory (+10 more)
...
Cohesion: 0.15
Nodes (4): InventoryItem, InventoryItemPolicy, PurchaseOrderLineFactory, StockMovementFactory
...
Cohesion: 0.23
Nodes (3): Pace, PaceObserver, PaceAssignmentStatus
...
Cohesion: 0.09
Nodes (4): PaceController, PurchaseOrderLineController, PurchaseOrderWorkflowController, Illuminate\Http\RedirectResponse
...
Cohesion: 0.10
Nodes (13): delegatedProps, props, BadgeVariants, CatalogueImport, ImportRow, canManage, Pace, page (+5 more)
...
Cohesion: 0.05
Nodes (17): ReportController, ReportExportController, ReportExportDownloadController, StoreReportExportRequest, GenerateReportExport, QueueHeartbeat, ReportExport, ReportExportPolicy (+9 more)

### Community 128 - "web.php"
Cohesion: 0.13
Nodes (7): InventoryController, StudentController, HandleInertiaRequests, StudentRegistrationService, Illuminate\Http\Request, Inertia\Middleware, Inertia\Response
...
Cohesion: 0.08
Nodes (23): CatalogueSetupController, CourseController, CurriculumController, LevelController, SchoolSettingController, StaffPasswordController, SubjectController, SystemStatusController (+15 more)
...
Cohesion: 0.18
Nodes (5): ProfileController, SecurityController, PasswordUpdateRequest, TwoFactorAuthenticationRequest, Laravel\Fortify\InteractsWithTwoFactorState
...
Cohesion: 0.16
Nodes (8): PaceAttemptController, PaceAttemptCorrectionController, PaceRetryApprovalController, StorePaceAttemptRequest, PaceAssessmentService, AssessmentOutcome, AssessmentType, RetryApprovalStatus
...
- **Why does `User` connect `NavigationMenuLink.vue` to `web.php`, `ProfileController.php`, `lib/utils.ts`, `SheetContent.vue`, `useAppearance.ts`, `TwoFactorSetupModal.vue`, `breadcrumb/index.ts`, `AppHeader.vue`, `@stylistic/eslint-plugin`, `ManageTwoFactor.vue`, `Layout.vue`, `FortifyServiceProvider.php`, `global.d.ts`, `ActivityLog`, `PasswordValidationRules.php`, `laravel-best-practices/SKILL.md`, `FortifyServiceProvider`, `DatabaseSeeder.php`, `DropdownMenuContent.vue`, `DropdownMenuRadioItem.vue`, `DropdownMenuSubContent.vue`, `package.json`, `DropdownMenuRadioGroup.vue`, `DropdownMenuSub.vue`, `autoload-dev`, `clsx`, `SidebarMenuButton.vue`, `PlaceholderPattern.vue`, `queue.php`?**
...
- **Why does `ActivityLogger` connect `SheetContent.vue` to `autoload-dev`, `web.php`, `ProfileController.php`, `PasswordValidationRules.php`, `clsx`, `SidebarMenuButton.vue`, `NavigationMenu.vue`, `DatabaseSeeder.php`, `ActivityLog`, `Alert.vue`, `AppHeader.vue`, `DropdownMenuRadioGroup.vue`?**
