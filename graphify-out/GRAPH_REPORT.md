...
Cohesion: 0.07
Nodes (9): ResetStaffPasswordRequest, SaveTermRequest, StoreCatalogueImportRequest, StoreStaffRequest, UpdateStaffRequest, PasswordUpdateRequest, StoreStudentRequest, UpdateStudentRequest (+1 more)
...
Cohesion: 0.09
Nodes (11): StaffPasswordController, PaceAttemptController, PaceAttemptCorrectionController, PaceRetryApprovalController, StudentStatusController, StorePaceAttemptCorrectionRequest, StorePaceAttemptRequest, StorePaceRetryApprovalRequest (+3 more)
...
Cohesion: 0.10
Nodes (6): CatalogueImportController, CourseController, LevelController, SaveCourseRequest, SaveLevelRequest, Illuminate\Http\RedirectResponse
...
Cohesion: 0.14
Nodes (7): CatalogueSetupController, SystemStatusController, Controller, ProfileController, SecurityController, TwoFactorAuthenticationRequest, Laravel\Fortify\InteractsWithTwoFactorState
...
- **Why does `ActivityLogger` connect `DropdownMenuCheckboxItem.vue` to `autoload-dev`, `web.php`, `keywords`, `PasswordValidationRules.php`, `AppSidebar.vue`, `useAppearance.ts`, `NavigationMenu.vue`, `DropdownMenuContent.vue`, `test`, `ProfileValidationRules.php`, `eslint-plugin-import`, `prettier`, `Alert.vue`, `DropdownMenuSub.vue`?**
