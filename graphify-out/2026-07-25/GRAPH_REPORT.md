# Graph Report - PMS  (2026-07-25)

## Corpus Check
- 621 files · ~122,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2909 nodes · 6184 edges · 193 communities (171 shown, 22 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 269 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `472c18fd`
...
- SidebarMenuButton.vue
- TwoFactorChallenge.vue
- purchase-orders/Index.vue
- test
- StorePaceAttemptRequest
...
1. `User` - 204 edges
2. `ActivityLogger` - 93 edges
3. `cn()` - 93 edges
4. `Level` - 66 edges
5. `Controller` - 63 edges
6. `PaceAssignment` - 63 edges
7. `Course` - 59 edges
8. `StudentEnrollment` - 49 edges
9. `PurchaseOrder` - 48 edges
10. `Term` - 46 edges
...
Cohesion: 0.08
Nodes (7): StudentEnrollmentController, SaveStudentEnrollmentRequest, Student, StudentPolicy, StudentEnrollmentService, StudentPromotionService, Illuminate\Database\Eloquent\Relations\HasOne

### Community 1 - "ProfileController.php"
Cohesion: 0.05
Nodes (14): CatalogueImportRow, GoodsReceipt, GoodsReceiptLine, PaceAttemptCorrection, PaceStatusEvent, StudentCourse, TuitionClearance, TuitionClearanceEvent (+6 more)
...
Cohesion: 0.06
Nodes (33): concurrently, eslint, eslint-config-prettier, eslint-import-resolver-typescript, @eslint/js, eslint-plugin-import, eslint-plugin-vue, devDependencies (+25 more)
...
Cohesion: 0.11
Nodes (4): StockMovement, StockMovementPolicy, StockLedgerService, StockMovementType
...
Cohesion: 0.04
Nodes (48): Props, props, props, props, props, props, props, props (+40 more)

### Community 14 - "types/index.ts"
Cohesion: 0.06
Nodes (33): className, Props, auth, { isCurrentUrl, whenCurrentUrl }, mainNavItems, page, Props, rightNavItems (+25 more)
...
Cohesion: 0.06
Nodes (33): apexcharts, class-variance-authority, @inertiajs/vite, @inertiajs/vue3, @laravel/passkeys, laravel-vite-plugin, @lucide/vue, dependencies (+25 more)
...
Cohesion: 0.20
Nodes (4): TuitionClearanceStatus, TuitionClearanceController, TermPaceTargetService, TuitionClearanceService
...
Cohesion: 0.10
Nodes (15): SidebarMenuButtonVariants, delegatedProps, { isMobile, state }, props, props, SidebarMenuButtonProps, emits, forwarded (+7 more)
...
Cohesion: 0.24
Nodes (6): GenerateReportExport, QueueHeartbeat, Illuminate\Contracts\Queue\ShouldBeUnique, Illuminate\Contracts\Queue\ShouldQueue, Illuminate\Foundation\Queue\Queueable, Throwable
...
Cohesion: 0.12
Nodes (6): PaceAttempt, PaceAttemptPolicy, AssessmentOutcome, AssessmentType, PaceAttemptCorrectionFactory, RetryApprovalStatus
...
Cohesion: 0.12
Nodes (7): NotifyStalePaceAssignments, PaceAssignment, PaceAssignmentPolicy, PaceAssignmentService, PaceAttemptFactory, PaceRetryApprovalFactory, PaceAssignmentStatus
...
Cohesion: 0.15
Nodes (4): PurchaseOrder, PurchaseOrderPolicy, PurchaseOrderService, PurchaseOrderStatus
...
Cohesion: 0.12
Nodes (16): AcademicYear, confirmDecision(), decisions, Enrollment, filters, Level, needsNextEnrollment(), Paginator (+8 more)
...
Cohesion: 0.07
Nodes (20): handleSubmit(), Approval, Assignment, confirmDecision(), props, search, Student, confirmCorrection() (+12 more)

### Community 59 - "AvatarFallback.vue"
Cohesion: 0.10
Nodes (13): formatDateOnly(), Order, props, searchText, status, Supplier, InventoryItem, localNow (+5 more)
...
Cohesion: 0.05
Nodes (15): CreateAdministrator, StaffController, StoreStaffRequest, UpdateStaffRequest, Permission, Role, CatalogueImportService, AccessControlSeeder (+7 more)
...
Cohesion: 0.07
Nodes (6): CancelPurchaseOrderRequest, PurchaseOrderDecisionRequest, StoreGoodsReceiptRequest, StorePurchaseOrderLineRequest, StorePurchaseOrderRequest, PurchaseOrderLine
...
Cohesion: 0.07
Nodes (13): CreateNewUser, ResetUserPassword, emailRules(), nameRules(), profileRules(), PasswordUpdateRequest, ProfileDeleteRequest, ProfileUpdateRequest (+5 more)
...
Cohesion: 0.05
Nodes (25): AcademicYear, Course, CurriculumRequirement, LearningCenter, Level, Pace, StudentEnrollment, Subject (+17 more)
...
Cohesion: 0.12
Nodes (7): PaceAttemptController, PaceAttemptCorrectionController, PaceRetryApprovalController, DecidePaceRetryApprovalRequest, StorePaceAttemptRequest, StorePaceRetryApprovalRequest, PaceAssessmentService

### Community 83 - "DropdownMenuContent.vue"
Cohesion: 0.07
Nodes (8): StorePaceAssignmentRequest, StorePaceAttemptCorrectionRequest, StoreStudentRequest, StoreSupplierRequest, UpdateStudentRequest, UpdateSupplierRequest, UpdateTuitionClearanceRequest, Illuminate\Foundation\Http\FormRequest

### Community 84 - "DropdownMenuRadioItem.vue"
Cohesion: 0.06
Nodes (19): AcademicYearFactory, CatalogueImportFactory, CatalogueImportRowFactory, CourseFactory, GoodsReceiptFactory, LearningCenterFactory, LevelFactory, PaceFactory (+11 more)

### Community 85 - "DropdownMenuSubContent.vue"
Cohesion: 0.16
Nodes (4): SchoolSetting, SchoolSettingPolicy, SchoolSettingFactory, self

### Community 86 - "NavigationMenuLink.vue"
Cohesion: 0.09
Nodes (7): Supplier, User, SupplierPolicy, UserPolicy, PurchaseOrderFactory, Illuminate\Database\Eloquent\Builder, Illuminate\Foundation\Auth\User
...
Cohesion: 0.15
Nodes (8): AcademicYear, ClearanceRow, expandedId, filters, Paginator, props, selectedYear, StatusOption
...
Cohesion: 0.10
Nodes (8): SubjectController, PurchaseOrderLineController, PurchaseOrderWorkflowController, SupplierController, SaveSubjectRequest, UpdateInventoryItemRequest, UpdatePurchaseOrderLineRequest, Illuminate\Http\RedirectResponse

### Community 104 - "DropdownMenuSeparator.vue"
Cohesion: 0.11
Nodes (13): active, allVisibleSelected, bulkForm, bulkScopeLabel(), CourseOption, Item, itemType, PaceOption (+5 more)

### Community 105 - "artisan"
Cohesion: 0.18
Nodes (10): Academic, academicMetrics, Clearance, clearanceMetrics, dashboardDescription, Inventory, inventoryMetrics, page (+2 more)

### Community 106 - "clsx"
Cohesion: 0.32
Nodes (3): InventoryBulkSettingsController, UpdateInventoryBulkSettingsRequest, InventoryBulkSettingsService

### Community 108 - "@inertiajs/vue3"
Cohesion: 0.07
Nodes (19): Props, Grade, StudentValues, Import, Course, Level, Subject, availablePaces (+11 more)
...
Cohesion: 0.15
Nodes (4): CatalogueImportController, SystemStatusController, StoreCatalogueImportRequest, CatalogueImport

### Community 117 - "test"
Cohesion: 0.08
Nodes (18): delegatedProps, props, BadgeVariants, CatalogueImport, ImportRow, canManage, Pace, page (+10 more)

### Community 122 - "queue.php"
Cohesion: 0.15
Nodes (5): ReportController, ReorderService, ReportDataService, Illuminate\Support\Collection, ReportType

### Community 128 - "web.php"
Cohesion: 0.08
Nodes (12): AssessmentController, DashboardController, DocumentationController, InventoryController, ReorderController, StudentController, HandleInertiaRequests, SaveCurriculumRequirementRequest (+4 more)

### Community 135 - "DataIntegrityService"
Cohesion: 0.33
Nodes (5): Item, props, quantities, selected, Supplier
...
Cohesion: 0.11
Nodes (7): PaceAssignmentStatusController, PaceIssuingController, StockMovementCorrectionController, CorrectStockMovementRequest, IssuePacesRequest, TransitionPaceAssignmentRequest, PaceIssueService
...
Cohesion: 0.10
Nodes (8): CatalogueSetupController, LevelController, Controller, ProfileController, SecurityController, SaveLevelRequest, TwoFactorAuthenticationRequest, Laravel\Fortify\InteractsWithTwoFactorState

### Community 146 - "useAppearance.ts"
Cohesion: 0.09
Nodes (23): { appearance, updateAppearance }, tabs, accessibleSummary, ApexChart, ChartSeries, mounted, options, props (+15 more)

### Community 151 - "eslint-plugin-import"
Cohesion: 0.07
Nodes (11): CurriculumController, GoodsReceiptController, InventoryItemController, PaceAssignmentController, PurchaseOrderController, StockMovementController, StudentStatusController, StoreInventoryItemRequest (+3 more)

### Community 152 - "StudentFactory"
Cohesion: 0.29
Nodes (4): props, props, props, AlertVariants

### Community 155 - "@stylistic/eslint-plugin"
Cohesion: 0.13
Nodes (5): PaceObserver, InventoryItemFactory, Illuminate\Http\UploadedFile, paceWorkbook(), UploadedFile
...
Cohesion: 0.29
Nodes (5): activeGuide, Guide, props, selectedRole, Workflow

### Community 183 - "purchase-orders/Index.vue"
Cohesion: 0.29
...
## Knowledge Gaps
- **945 isolated node(s):** `$schema`, `style`, `config`, `css`, `baseColor` (+940 more)
...
- **Why does `User` connect `NavigationMenuLink.vue` to `web.php`, `ProfileController.php`, `lib/utils.ts`, `useAppearance.ts`, `TwoFactorSetupModal.vue`, `Alert.vue`, `eslint-plugin-import`, `ManageTwoFactor.vue`, `Layout.vue`, `FortifyServiceProvider.php`, `global.d.ts`, `test`, `StudentFactory`, `PasswordValidationRules.php`, `UserFactory`, `AppSidebar.vue`, `laravel-best-practices/SKILL.md`, `DatabaseSeeder.php`, `DropdownMenuContent.vue`, `DropdownMenuRadioItem.vue`, `DropdownMenuSubContent.vue`, `package.json`, `DropdownMenuRadioGroup.vue`, `keywords`, `SidebarMenuButton.vue`, `PlaceholderPattern.vue`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `cn()` connect `User.php` to `select/index.ts`, `dialog/index.ts`, `Sidebar.vue`, `SidebarMenuSkeleton.vue`, `SidebarProvider.vue`, `InputError.vue`, `Checkbox.vue`, `navigation-menu/index.ts`, `types/index.ts`, `InputOTPSlot.vue`, `test`, `card/index.ts`, `StudentFactory`, `TooltipContent.vue`, `dropdown-menu/index.ts`, `UserInfo.vue`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `ActivityLogger` connect `eslint-plugin-import` to `web.php`, `autoload-dev`, `lib/utils.ts`, `PasswordValidationRules.php`, `eslint-plugin-import`, `SheetContent.vue`, `clsx`, `@inertiajs/vite`, `tailwindcss`, `SidebarMenuButton.vue`, `NavigationMenu.vue`, `DropdownMenuRadioGroup.vue`, `PlaceholderPattern.vue`, `DropdownMenuCheckboxItem.vue`, `Alert.vue`, `breadcrumb/index.ts`, `Alert.vue`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Are the 19 inferred relationships involving `User` (e.g. with `.handle()` and `.handle()`) actually correct?**
