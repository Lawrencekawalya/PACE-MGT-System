                ...
                'workflows' => [
                    ...
                    [
                        ...
                        'steps' => [
                            ...
                            'After the physical delivery is counted, enter only the actual quantities in the exported file’s Quantity delivered now column.',
                            'Open Sent orders, import the completed file, and resolve every validation error before continuing.',
                            'Review the delivery preview, enter its reference, date, and notes, then post the goods receipt; partial quantities leave the order available for a later delivery.',
