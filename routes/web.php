...
use App\Http\Controllers\PurchaseOrderReceiptImportController;
...
use App\Http\Controllers\ScoreKeyRequestController;
use App\Http\Controllers\ScoreKeyRequestWorkflowController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('purchase-orders/sent', [PurchaseOrderQueueController::class, 'sent'])->name('purchase-orders.sent');
    ...
    Route::post('purchase-orders/{purchase_order}/receipt-imports', [PurchaseOrderReceiptImportController::class, 'store'])->name('purchase-orders.receipt-imports.store');
    Route::get('purchase-order-receipt-imports/{purchase_order_receipt_import}', [PurchaseOrderReceiptImportController::class, 'show'])->name('purchase-order-receipt-imports.show');
    Route::post('purchase-order-receipt-imports/{purchase_order_receipt_import}/commit', [PurchaseOrderReceiptImportController::class, 'commit'])->name('purchase-order-receipt-imports.commit');
    Route::post('purchase-order-receipt-imports/{purchase_order_receipt_import}/cancel', [PurchaseOrderReceiptImportController::class, 'cancel'])->name('purchase-order-receipt-imports.cancel');
    ...
    Route::get('score-key-requests', [ScoreKeyRequestController::class, 'index'])->name('score-key-requests.index');
    Route::post('score-key-requests', [ScoreKeyRequestController::class, 'store'])->name('score-key-requests.store');
    Route::post('score-key-requests/{score_key_request}/cancel', [ScoreKeyRequestController::class, 'cancel'])->name('score-key-requests.cancel');
    Route::post('score-key-requests/{score_key_request}/issues', [ScoreKeyRequestWorkflowController::class, 'issue'])->name('score-key-requests.issues.store');
    Route::post('score-key-requests/{score_key_request}/reject', [ScoreKeyRequestWorkflowController::class, 'reject'])->name('score-key-requests.reject');
