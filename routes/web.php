...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::put('inventory/bulk-settings', InventoryBulkSettingsController::class)->name('inventory.bulk-settings.update');
    ...
    Route::delete('purchase-order-lines/{purchase_order_line}', [PurchaseOrderLineController::class, 'destroy'])->name('purchase-order-lines.destroy');
    Route::post('purchase-orders/{purchase_order}/submit', [PurchaseOrderWorkflowController::class, 'submit'])->name('purchase-orders.submit');
    Route::post('purchase-orders/{purchase_order}/decision', [PurchaseOrderWorkflowController::class, 'decide'])->name('purchase-orders.decision');
    Route::post('purchase-orders/{purchase_order}/send', [PurchaseOrderWorkflowController::class, 'send'])->name('purchase-orders.send');
    Route::post('purchase-orders/{purchase_order}/cancel', [PurchaseOrderWorkflowController::class, 'cancel'])->name('purchase-orders.cancel');
    Route::post('purchase-orders/{purchase_order}/receipts', [GoodsReceiptController::class, 'store'])->name('purchase-orders.receipts.store');
